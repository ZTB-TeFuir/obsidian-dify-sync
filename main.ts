...
export default class DifySyncPlugin extends Plugin {
    ...
    // 检测配置缺失时弹出设置弹框
    private promptSettings(onSubmit: () => void) {
...
class DeleteConfirmModal extends Modal {
    ...
    constructor(app: App, message: string, onPull: () => void, onDelete: () => void) {
        super(app);
...
class SettingsModal extends Modal {
    ...
    constructor(app: App, plugin: DifySyncPlugin, onSubmit: () => void) {
        super(app);
        this.plugin = plugin;
    ...
    onOpen() {
        ...
        new Setting(contentEl)
            ...
            .addText(text => text
                ...
                .onChange(v => this.plugin.settings.apiBase = v));
        ...
        new Setting(contentEl)
            ...
            .addText(text => text
                ...
                .onChange(v => this.plugin.settings.apiKey = v));
        ...
        new Setting(contentEl)
            ...
            .addText(text => text
                ...
                .onChange(v => this.plugin.settings.datasetId = v));
